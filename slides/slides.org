...
#+begin_src sh
  $ mkdir xpanther
#+end_src
** Putting in the foundation 					      :slide:
...
#+end_src
** Building and testing the gem					      :slide:
#+begin_src sh
...
#+end_src
** Adding the extension infrastructure				      :slide:
...
#+end_src
** Trying out the extension					      :slide:
#+begin_src sh
