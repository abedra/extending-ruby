...
#+end_src
  - This is quite a bit faster than our original test! This very
    scientific benchmarking process proves that with a little bit of
    effort and some help from your old pal C, you can speed Ruby up
    quite a bit.
* References
  - 
